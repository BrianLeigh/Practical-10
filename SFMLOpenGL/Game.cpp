...
void Game::initialize()
{
	...
	vertex[0].texel[0] = 0.1f;
	vertex[0].texel[1] = 0.1f;

	vertex[1].texel[0] = 0.3f;
	vertex[1].texel[1] = 0.2f;

	vertex[2].texel[0] = 0.1f;
	vertex[2].texel[1] = 0.3f;

	vertex[3].texel[0] = 0.3f;
	vertex[3].texel[1] = 0.3f;

	vertex[4].texel[0] = 0.1f;
	vertex[4].texel[1] = 0.2f;

	vertex[5].texel[0] = 0.3f;
	vertex[5].texel[1] = 0.1f;

	vertex[6].texel[0] = 0.1f;
	vertex[6].texel[1] = 0.1f;

	vertex[7].texel[0] = 0.3f;
	vertex[7].texel[1] = 0.2f;
	...
	//Left face
	triangles[12] = 1;   triangles[13] = 0;   triangles[14] = 7;
	triangles[15] = 1;   triangles[16] = 6;   triangles[17] = 7;

	//back face
	triangles[18] = 7;   triangles[19] = 5;   triangles[20] = 6;
	triangles[21] = 5;   triangles[22] = 4;   triangles[23] = 6;
